...
public class movieyear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movieyear);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childList != null && childPosition < childList.size()) {
                    ...
                    Intent intent = new Intent(movieyear.this, selectedentertainment.class);
    ...
    private void initData() {
        ...
        groupTitles.add("1988");

        // Initialize child items
        childItems = new HashMap<>();
        addChildItems("2023", "Suzume","Ghosted", "Pathaan","Dungeons & Dragons: Honour Among Thieves","Virupaksha", "John Wick: Chapter 4","Dasara","Guardians of the Galaxy Vol. 3", "My Fault");
        addChildItems("2022", "RRR", "The Batman","The Pale Blue Eye","Death on the Nile","K.G.F: Chapter 2","Brahmāstra: Part One – Shiva", "Fantastic Beasts: The Secrets of Dumbledore","Everything Everywhere All at Once","Top Gun: Maverick","HIT: The Second Case", "Avatar: The Way of Water","Sita Ramam");
        addChildItems("2021", "Dune","The Tomorrow War");
        addChildItems("2020", "Tenet");
        addChildItems("2019", "After", "Weathering with You");
        addChildItems("2018", "");
        addChildItems("2017", "Bahubali 2", "Geostorm");
        addChildItems("2016", "La La Land", "A Silent Voice", "Your Name.");
        addChildItems("2015", "Fifty Shades of Grey", "The Martian");
        addChildItems("2014", "Interstellar");
        addChildItems("2013", "");
        addChildItems("2012", "");
        addChildItems("2011", "");
        addChildItems("2008", "Twilight");
        addChildItems("2001", "Spirited Away");
        addChildItems("1988", "Akira");
