...
public class tvshowlanguage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvshowlanguage);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childList != null && childPosition < childList.size()) {
                    ...
                    Intent intent = new Intent(tvshowlanguage.this, selectedentertainment.class);
    ...
    private void initData() {
        ...
        groupTitles.add("English");
        groupTitles.add("Japanese");
        groupTitles.add("Korean");

        // Initialize child items
        childItems = new HashMap<>();
        addChildItems("English", "The Walking Dead","Stranger Things","Invasion","The Expanse","Halo","Lost in Space","The Big Bang Theory","Modern Family","Chuck","Friends", "Outlander","Game of Thrones","The Summer I Turned Pretty","The Vampire Diaries","YOU", "The Wheel of Time","Breaking Bad","Sherlock", "Reacher", "Shadow and Bone","Peaky Blinders", "Prison Break","Dark");
        addChildItems("Japanese", "One Piece","Black Clover","Demon Slayer: Kimetsu no Yaiba","How a Realist Hero Rebuilt the Kingdom", "My Hero Academia","Jujutsu Kaisen","Gintama","The Eminence in Shadow","Uncle From Another World","Blue Lock","Haikyuu!!", "KonoSuba: God's Blessing on This Wonderful World!");
        addChildItems("Korean", "Vincenzo");
