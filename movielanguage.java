...
public class movielanguage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movielanguage);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childList != null && childPosition < childList.size()) {
                    ...
                    Intent intent = new Intent(movielanguage.this, selectedentertainment.class);
    ...
    private void initData() {
        ...
        groupTitles.add("Telugu");
        groupTitles.add("Hindi");
        groupTitles.add("Japanese");

        // Initialize child items
        childItems = new HashMap<>();
        addChildItems("English", "Interstellar","The Martian","Geostorm","Tenet","The Tomorrow War","Death on the Nile","The Pale Blue Eye","Fantastic Beasts: The Secrets of Dumbledore","Dungeons & Dragons: Honour Among Thieves","Guardians of the Galaxy Vol. 3","Dune","The Batman","Twilight","La La Land","My Fault","After","Fifty Shades of Grey","Ghosted", "Top Gun: Maverick", "Avatar: The Way of Water", "Item 4");
        addChildItems("Telugu", "RRR", "Bahubali 2","Sita Ramam", "K.G.F: Chapter 2","Dasara", "HIT: The Second Case");
        addChildItems("Hindi", "Brahmāstra: Part One – Shiva", "Pathaan");
        addChildItems("Japanese", "Suzume", "Your Name.","A Silent Voice", "Weathering with You","Akira");
