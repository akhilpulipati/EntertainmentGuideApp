...
public class tvshowyear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvshowyear);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childList != null && childPosition < childList.size()) {
                    ...
                    Intent intent = new Intent(tvshowyear.this, selectedentertainment.class);
    ...
    private void initData() {
        ...
        groupTitles.add("2023");
        groupTitles.add("2022");
        groupTitles.add("2021");
        groupTitles.add("2020");
        groupTitles.add("2019");
        groupTitles.add("2018");
        groupTitles.add("2017");
        groupTitles.add("2016");
        groupTitles.add("2015");
        groupTitles.add("2014");
        groupTitles.add("2013");
        groupTitles.add("2012");
        groupTitles.add("2011");
        groupTitles.add("2010");
        groupTitles.add("2009");
        groupTitles.add("2008");
        groupTitles.add("2007");
        groupTitles.add("2006");
        groupTitles.add("2005");
        groupTitles.add("2004");
        groupTitles.add("2003");
        groupTitles.add("2002");
        groupTitles.add("2001");
        groupTitles.add("2000");
        groupTitles.add("1999");
        groupTitles.add("1994");

        // Initialize child items
        childItems = new HashMap<>();
        addChildItems("2023", "");
        addChildItems("2022", "The Eminence in Shadow","Uncle From Another World","Blue Lock","Halo","The Summer I Turned Pretty","Reacher");
        addChildItems("2021", "How a Realist Hero Rebuilt the Kingdom","Invasion","Vincenzo","The Wheel of Time","Shadow and Bone");
        addChildItems("2020", "Jujutsu Kaisen");
        addChildItems("2019", "Demon Slayer: Kimetsu no Yaiba");
        addChildItems("2018", "Lost in Space","YOU");
        addChildItems("2017", "Black Clover","Dark");
        addChildItems("2016", "KonoSuba: God's Blessing on This Wonderful World!", "konosuba","My Hero Academia","Stranger Things","Lucifer");
        addChildItems("2015", "The Expanse");
        addChildItems("2014", "Haikyuu!!","Outlander");
        addChildItems("2013", "Peaky Blinders");
        addChildItems("2012", "");
        addChildItems("2011", "Game of Thrones");
        addChildItems("2010", "Sherlock","The Walking Dead");
        addChildItems("2009", "Modern Family","The Vampire Diaries");
        addChildItems("2008", "Breaking Bad");
        addChildItems("2007", "The Big Bang Theory","Chuck");
        addChildItems("2006", "Gintama");
        addChildItems("2005", "Prison Break");
        addChildItems("2004", "");
        addChildItems("2003", "");
        addChildItems("2002", "");
        addChildItems("2001", "");
        addChildItems("2000", "");
        addChildItems("1999", "One Piece");
        addChildItems("1994", "Friends");
